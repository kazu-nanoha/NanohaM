...
// インスタンス化.
template void do_move<true>(int move);
template void do_move<false>(int move);
template void undo_move<true>(int move);
template void undo_move<false>(int move);
template int is_legal<true>(int move);
template int is_legal<false>(int move);
template int is_check<true>(int move);
template int is_check<false>(int move);
